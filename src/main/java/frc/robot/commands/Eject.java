...
public class Eject extends Command {
  ...
  public Eject(BallSubsystem ballSystem) {
    addRequirements(ballSystem);
    this.ballSubsystem = ballSystem;
  }
  ...
  public void initialize() {
    ...
    ballSubsystem
        .runIntake(-1 * SmartDashboard.getNumber("Intaking feeder roller value", INTAKING_FEEDER_VOLTAGE));
  }
